        ...
        return {
          content: [{
            ...
            text: JSON.stringify({
              ...
              statusMessage: e.message ?? "CheckQueryRq failed",
        ...
        return {
          content: [{
            ...
            text: JSON.stringify({
              success: false,
              statusCode: e.statusCode ?? -1,
              statusMessage: e.message ?? "CheckAddRq failed",
              ...(humanReadable ? { humanReadable } : {}),
            }),
          }],
          isError: true,
        ...
        return {
          content: [{
            ...
            text: JSON.stringify({
              success: false,
              statusCode: e.statusCode ?? -1,
              statusMessage: e.message ?? "CheckModRq failed",
              ...(humanReadable ? { humanReadable } : {}),
            }),
          }],
          isError: true,
        ...
        return {
          content: [{
            ...
            text: JSON.stringify({
              success: false,
              statusCode: e.statusCode ?? -1,
              statusMessage: e.message ?? "TxnDelRq (Check) failed",
              ...(humanReadable ? { humanReadable } : {}),
            }),
          }],
          isError: true,
