...
- [ ] **12.** Add missing transaction tools: ~~`qb_sales_receipt_*`~~ (done 2026-04-26), `qb_credit_memo_*`, `qb_purchase_order_*`, `qb_journal_entry_*` (parser already declares `Ret` arrays for these, but no tool exposes them).
